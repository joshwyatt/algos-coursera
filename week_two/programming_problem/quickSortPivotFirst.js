function quickSortPivotFirst(array){
  ...
  return quickSortPivotFirst(array.slice(0, i - 1)).concat(array[i - 1]).concat(quickSortPivotFirst(array.slice(i)));
...
module.exports = quickSortPivotFirst;